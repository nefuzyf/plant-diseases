...
parser.add_argument('--dataset', default='my', help='which dataset to train on, CIFAR|MNIST')
...
if (opt.dataset == 'MNIST'):
    ...
    dataset = dset.ImageFolder('E:\plant disease\data\Apple Cedar',
                               transform=transforms.Compose([
                                   transforms.Scale(opt.imageSize),
                                   transforms.ToTensor(),
                                   ]))

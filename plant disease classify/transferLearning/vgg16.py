...
if __name__ == '__main__':
    ...
    trainset = torchvision.datasets.ImageFolder('D:/Apple/train', transform=transform_train)
    ...
    testset = torchvision.datasets.ImageFolder('D:/Apple/test', transform=transform_test)
